...
const Navbar = () => {
  ...
  const navLinks = [
    { name: 'Dashboard', path: '/userDashboard', icon: <Home size={18} /> },
    { name: 'Map', path: '/userMainNavigation', icon: <Calendar size={18} /> },
    { name: 'Report', path: '/userReportForm', icon: <Flag size={18} /> },
    { name: 'Complaints', path: '/complaints', icon: <User size={18} /> },
  ];
